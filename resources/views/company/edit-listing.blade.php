<x-layout title="Editar vaga" column="true">
    ...
    <div class="container">
        ...
        <div class="border-2 border-[#7777] p-6 rounded w-[60%]">
            ...
            <form action="/editar/vaga/{{ $listing->id }}" method="post">
                @csrf
                @method("POST")
                <div class="flex flex-col my-2">
                    ...
                    p-1 outline-none w-[100%]" name="title" value="{{ $listing->title }}">
                </div>
                ...
                <div class="flex flex-col my-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="text" class="border border-[#7777] rounded
                        p-1 outline-none w-[100%]" name="salary" value="{{ $listing->salary }}">
                    </div>
                </div>
                <div class="border my-3"></div>
                <div class="flex flex-col my-2">
                    ...
                    class="border border-[#7777] rounded p-1 outline-none w-[100%]">
                        <option value="{{ $listing->state->acronym ?? "" }}" class="default">
                            {{ $listing->state->state ?? "Selecione um estado" }}
                        </option>
                ...
                <div class="flex flex-col my-2">
                    ...
                    class="border border-[#7777] rounded p-1 outline-none w-[100%]">
                        <option value="{{ $user->city->id ?? "" }}" class="default">
                            {{ $listing->city->name ?? "Selecione uma cidade" }}
                        </option>
                    </select>
                </div>
                <div class="border my-3"></div>
